...
| Kontaktformular: Felder Name, E-Mail oder Telefon, Nachricht; Zustellung an das Firmenpostfach | Kontakt | Briefing, Abschnitt 5 (Kontaktformular); ADR-0002 | aus Primärquelle; Empfängeradresse offen (`D-003`) |
| Antworttext «Wir haben Ihre Nachricht erhalten und melden uns bei Ihnen» | Kontaktformular, Danke-Seite | Team | offen: Antwortfrist (`D-013`) |
